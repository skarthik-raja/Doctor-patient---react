...
import { useRoutes, useNavigate } from 'react-router-dom'; // Import useNavigate
...
const PatientLogin = () => {
  const api_url = "https://localhost:7175/api/Token/Patient";
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/view'); // Redirect to another page
    } catch (error) {
